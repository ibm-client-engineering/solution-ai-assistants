...
#### [**Hosted Webpage**](/Create/User%20Interface%20Integrations/solution-hosted-webapp)
Adapted the assistant to a custom user-interface skin which enabled additional capabiltiies like showing "cloest ATMs" via a map iframe.
