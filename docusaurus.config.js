...
async function createconfig() {
  ...
  const config = {
    ...
    title: "AI Assistants for Customer Care",
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              "https://github.com/ibm-client-engineering/solution-ai-assistants/tree/main/packages/create-docusaurus/templates/shared/",
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              "https://github.com/ibm-client-engineering/solution-ai-assistants/edit/main/${blogDirPath}/${blogPath}",
      ...
      ({
        ...
        navbar: {
          ...
          items: [
            ...
            {
              href: "https://github.com/ibm-client-engineering/solution-ai-assistants",
